...
--
-- Classic/Join Syntax - could forget a join condition - result cartesian product
--
Select last_name, first_name, description
 ...
 ; 
--
-- Modern / New Syntax - cannot forget a join condition - to Cartesian products
--
Select last_name
from actor             -- first table
     inner join        -- type of join - inner join - shows the matches between the tables
     film_actor        -- second table
  on actor.actor_id = film_actor.actor_id    -- join condition
     inner join        -- type of join
     film              -- next table - the result of the first join is matched to this table
...
select first_name, 'is an actor'
  from actor
union all       -- concatenate results from two or more queries
select first_name, 'is a customer'
   from customer
--order by first_name
;