...
@Component   // tell Spring MVC this has something it might care about
...
public class JdbcParkDAO implements ParkDAO {
    ...
    public Park getParkById(int parkId) {
    	...
    	String parksQuery = "Select * from park where park_id = ?";
    	
    	SqlRowSet results = jdbcTemplate.queryForRowSet(parksQuery, parkId);
