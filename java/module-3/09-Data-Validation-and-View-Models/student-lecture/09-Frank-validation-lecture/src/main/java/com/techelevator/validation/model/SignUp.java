...
public class SignUp {  // POJO class
	
	// Place the validation annotation before the field to be validated
	// message= is the message to be displayed when the invalid data is entered
	...
	public boolean isEmailMatching() {			// method returns a result which is validated (isBooleanName - standard getter for a boolean)
		if(email != null) {
