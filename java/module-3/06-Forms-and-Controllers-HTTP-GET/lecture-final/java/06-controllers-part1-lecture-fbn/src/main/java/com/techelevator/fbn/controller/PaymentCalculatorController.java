...
public class PaymentCalculatorController {
	...
	public String showMortgagePaymentCalculatorResults(
			 ...
			 * proper Java type and assign them to these variables. 
			 * 
			 * the variable name in @RequestParam must match the query string variable names
			 * 
			 * Use the variable names from @RequestParam in you Jaca code / method
			 * */
		...
		// Instantiate an object to calculate the payment
