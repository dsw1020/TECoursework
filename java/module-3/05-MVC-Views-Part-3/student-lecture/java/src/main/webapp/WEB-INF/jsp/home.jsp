...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	...
	<c:import url="/WEB-INF/jsp/header.jsp">  <!-- When you import a .jsp, you bring the HTML tags along with it, i.e. body tags on the header and footer encompase the home file -->
