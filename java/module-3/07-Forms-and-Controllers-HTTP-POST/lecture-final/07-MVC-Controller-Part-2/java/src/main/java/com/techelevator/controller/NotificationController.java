...
public class NotificationController {
	...
	public String processNotificationSignupSubmission(@RequestParam String firstName
		...
		return "redirect:/notificationSignupResult";  // Go to this URL - this is NOT a view name 
	}
	...
	private File getSignupLogFile() {
		String homeDirectory = System.getProperty("user.home");    // Go get the home directory of user
		return new File(homeDirectory, "notificationSignups.csv"); // Put/Access teh file in the homeDirectory
	}
}
