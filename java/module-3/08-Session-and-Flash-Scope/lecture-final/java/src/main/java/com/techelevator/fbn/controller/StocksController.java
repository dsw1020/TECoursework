...
@Controller
@SessionAttributes("stocks")   // Treat this entry in that is in a ModelMap or RequestMap as a Session object
                               //      this entry will live across requests for the life of the session
