...
<html>
	...
	<body>
		...
		<table>
			<tr>   <!-- Generate a table row -->
				<th>inches</th>      <!-- header value for first column in row  -->
				<th>centimeters</th> <!-- header value for second column in row -->
			</tr>
			...
			<c:forEach begin="1" end="12" var="inches">
				<tr>
				    ...
				    by this JSP --%>
					<td>${inches}</td>          <!-- Value for first column   -->
					<td>${inches * 2.54}</td>   <!--  value for second column -->
				</tr>	
			</c:forEach>
		</table>
