...
<html>
	...
	<body>
		...
		<table>
			<tr>
				<th>inches</th> <!--  header value for the first column in row -->
				<th>centimeters</th> <!--  header value for the second column in row -->
			...
			<c:forEach begin="1" end="12" var="inches">
				<tr>
				    ...
				    by this JSP --%>
					<td>${inches}</td> <!--  Value for the first column -->
					<td>${inches * 2.54}</td> <!--  Value for the second column- -->
				</tr>	
			</c:forEach>
		</table>
