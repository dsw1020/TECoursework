...
public class Lecture {
    ...
    */
    public boolean returnTrueWhenGreaterThanFiveInOneLine(int number) {
        return number >  5; // result of number > 5 is true or false
    ...
    */
    public int returnNumberAfterAddThreeAndAddFive(int number, boolean addThree, boolean addFive) {
        if (addThree == true) { //addThree is a boolean so it's already true or false
            number = number + 3;
        }

        // We can't use an else here. They could both be true, so we have to check each one.

        if (addFive == true) { // addFive is a boolean so it's already true or false
            number += 5;
        }
    ...
    /*
    11. Write an if statement that returns "Fizz" if the parameter is 
    3 and returns an empty String for anything else.
    */
    ...
    */
    ...
    /*
    13. Write an if/else statement that returns "Fizz" if the parameter 
    is 3, "Buzz" if the parameter is 5 and an empty String for anything else.
    */
    ...
    /*
    14. Write an if statement that checks if the parameter number is 
    either equal to or greater than 18. Return "Adult" if it is or "Minor" if it's not.
    */
