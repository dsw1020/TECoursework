...
//		}
	...
	public int luckySum(int a, int b, int c) {
		if ( a == 13 && b == 13) {  // if a and b are 13 skip all
		return 0;
		}
		if (a == 13) { 				// if a is 13, skip b
			return c;
		}
		if (b == 13) { 				// b is 13, skip c
			return a;
		}
		if (c == 13) {				// if c is 13, return a + b
			return a + b;
		}
		return a + b + c;			// if none are 13, return sum of a+b+c
	}
}
