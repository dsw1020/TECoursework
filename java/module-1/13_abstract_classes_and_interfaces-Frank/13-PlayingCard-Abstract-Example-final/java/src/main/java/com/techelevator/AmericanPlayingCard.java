...
public class AmericanPlayingCard extends PlayingCard{
	...
	{
		value = DEFAULTCARDVALUE;  // setting the data in super class from this subclass
		suit  = DEFAULTSUIT;       // setting the data in super class from this subclass
		color = DEFAULTCOLOR;      // setting the data in super class from this subclass
	} 
