...
public abstract class PlayingCard { // abstract - cannot be instantiated - only be a super class
	...
	// abstract method requires a sub-class implementation
	// abstract method only provides the method signature - no code - no {}
	
	abstract public void showCard();    // Eclipse generated method - does nothing
