 ...
 ***************************************************************************************************/
	...
	public void dealHand(CardDeck aDeck) {             // Deal a Hand - Overriding the abstract method in CardHand
		...
		}											   // aHand is defined in the super class so we use the super keyword
													   // aHand is protected in the super so we can access it from subclass
	}
