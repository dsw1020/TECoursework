...
//********************************************************************************************
	...
	// equals method is going to require an option to tell us what to compare
	// "value" - compare just the value
	// "suit" - compare just the suit
	// "both" - compare the value and the suit
		...
		public boolean equals(PlayingCard otherCard, String option) {
			...
			return false; // if no valid option - return false
		}
		public boolean equals(PlayingCard otherCard) {	// default .equals
