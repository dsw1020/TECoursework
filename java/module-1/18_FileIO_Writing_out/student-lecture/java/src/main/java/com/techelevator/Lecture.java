...
public class Lecture {
	...
	public static void main(String[] args) throws IOException {
		...
		// Define file File object for the file name
		File newFile = new File(newDirectory, fileName);
		
		// Create the new file using the File object on disk if it doesn't exist with createNewFile();
		...
		// Define PrintWriter for the File that points to the disk file
		
		try(PrintWriter writer = new PrintWriter(newFile)) {	// position to write at the start of the file 
																// you will overlay the data in an existing file
			
			writer.println(message);		// Use the same methods you used with System.out to write the file
