...
public class LectureTest {
	...
	public void length_returns_the_number_of_characters_in_a_String() {
		...
		String theString = "Java"; // Arrange - Setup the data for the test	
		int length = theString.length(); // Act - Run the method with the data
		Assert.assertEquals(4, length); // Assert - Check the result 
		Assert.assertEquals(4, theString.length()); // Assert - Check the result 
	}
