...
function filterEvens(anArray) {
	...
	for (let i=0; i < anArray.length; i++) {
		if (anArray[i]%2==0) {
			onlyEvenNumbers.push(anArray[i]);
		}	
	}
...
function filterBigNumbers(anArray) {
	let onlyBiggerNumbers = []
	for (let i=0; i < anArray.length; i++) {
		if (anArray[i] >= 100) {
			onlyBiggerNumbers.push(anArray[i]);
		}	
	}
	return onlyBiggerNumbers;
}
...
function filterMultiplesOfX(anArray, x) {
	let multiplesOfX = []
	for (let i=0; i < anArray.length; i++) {
		if (anArray[i]%x==0) {
			multiplesOfX.push(anArray[i]);
		}	
	}
	return multiplesOfX;
}
